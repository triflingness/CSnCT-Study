...
- 레지스터: 데이터를 처리하는 동안 사용하는 값이나 연산의 중가 결과를 일시적으로 기억하는 __고속 기억장치__
...
- 하드웨어의 기능을 실행하기 위해 필수적인 작업(명령어 해석, 하드디스크에 데이터 저장, 주변장치와의 통신)을 하거나 응용 소프트웨어의 실행을 지원하는 소프트웨어
  ...
  - 링커: 다수로 분할하여 작성된 프로그램 의 생성된 목적 프로그램(object program) 또는 라이브러리 루틴을 결합하여 실행 가능한 하나의 프로그램으로 연결하는 소프트웨어
